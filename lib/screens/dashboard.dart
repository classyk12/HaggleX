  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: TabNavigationItem.items.map((TabNavigationItem destination) {
            return BottomNavigationBarItem(
                icon: destination.icon, label: destination.title
                // activeIcon: destination.,
                );
          }).toList(),
        ),
        body: ListView(
                  ...
                  itemBuilder: (context, i) {
                    return ListTile(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(children: [
                                ...
                                Text(
                                    ' ${DashBoardMockClass.getData[i].percentage}',
                                    style: TextStyle(
                        ...
                        trailing: Image.asset(
                            DashBoardMockClass.getData[i].graph,
                            height: 100,
                            width: 100));
                  },
                ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  _doMoreCard(
                      ...
                      'sendmoney.png'),
                  _doMoreCard('Global Remittance',
                      'Send money to anyone, anywhere', 'recievemoney.png'),
                ],
              ),
            ),
            YMargin(15),
                  ...
                  itemBuilder: (context, i) {
                    return ListTile(
                      ...
                      leading: ClipRRect(
                          ...
                          child:
                              Image.asset('assets/images/bitcoin-news.jpeg')),
                      //     height: 100, width: 60),
                      title: Padding(
